...
class Library(QWidget):
    ...
    def __init__(self):
        ...
        zoneconf2.append({"offset1": 110, "lengthled": 20})
        zoneconf2.append({"offset1": 130, "lengthled": 10})
        zoneconf2.append({"offset1": 140, "lengthled": 10})
        zoneconf2.append({"offset1": 150, "lengthled": 10})
        zoneconf2.append({"offset1": 160, "lengthled": 10})
